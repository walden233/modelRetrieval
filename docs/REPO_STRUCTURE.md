...
- `docs/semantic/SEMANTIC_VLM_MODULE_PLAN.md`：语义层 VLM 模块完整开发方案，覆盖技术栈、数据组织、测试、指标和实验呈现。
- `docs/semantic/SEMANTIC_VLM_IMPLEMENTATION_GUIDE.md`：语义层 VLM 模块开发实现文档，面向具体代码实现、文件职责、数据流和分阶段落地。
