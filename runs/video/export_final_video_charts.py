...
def parse_args():
    ...
    parser.add_argument("--metrics-filename", default="video_metrics_comparison.png", help="Output filename for the metrics chart.")
    parser.add_argument("--curves-filename", default="video_curves_comparison.png", help="Output filename for the curves chart.")
